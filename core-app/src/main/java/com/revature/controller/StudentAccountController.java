...
public class StudentAccountController {
	...
	// public String passwordInsertController(@PathVariable("password") String
	// password,@PathVariable("emailId") String emailId) {
	// String studentAccount = null;
	//
	// try {
	// logger.info("encrypting...");
	// studentAccount =
	// studentAccountService.insertUserPassword(password,emailId);
